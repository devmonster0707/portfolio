    ...
    emailjs
      .send(
        ...
        "template_jyzolum", // template_id
        {
          ...
          to_email: "devmonster0707@gmail.com",
      ...
      >
        ...
        <div className="my-10">
          ...
          <div className="flex flex-row items-center space-x-5 text-lg text-gray-300">
            ...
            <div>
              <p className="text-2xl">Harry Towns</p>
              <a
                onClick={() => copyToClipboard("devmonster0707@gmail.com")}
                className="underline cursor-pointer"
              >
                devmonster0707@gmail.com
              </a>
            </div>
          </div>
        </div>
        ...
        {/* <div className="my-10">
          ...
          <div className="flex flex-row items-center space-x-5 text-lg text-gray-300">
            ...
            <div>
              <p className="text-2xl">Lucky Angel</p>
              <a
                onClick={() => copyToClipboard("live:.cid.b9f0dadc04892502")}
                className="underline cursor-pointer"
              >
                live:.cid.b9f0dadc04892502
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="my-10">
          ...
          <div className="flex flex-row items-center space-x-5 text-lg text-gray-300">
            ...
            <div>
              <p className="text-2xl">LuckyAngel</p>
              <a
                onClick={() => copyToClipboard("luckyangel0615_85393")}
                className="underline cursor-pointer"
              >
                luckyangel0615_85393
              </a>
            </div>
          </div>
        </div> */}
        ...
        <div className="my-10">
          ...
          <div className="flex flex-row items-center space-x-5 text-lg text-gray-300">
            ...
            <div>
              <p className="text-2xl">devmonster0707</p>
              <a
                href="https://github.com/devmonster0707"
                target="_blank"
                className="underline cursor-pointer"
              >
                https://github.com/devmonster0707
              </a>
            </div>
          </div>
        </div>
