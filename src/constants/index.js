...
const testimonials = [
  {
    testimonial:
      "Collaborating with Dale was an absolute pleasure. His professionalism, promptness, and dedication to delivering exceptional results were evident throughout our project. Adrian's enthusiasm for every facet of development truly stands out.",
    name: "Sara Lee",
    designation: "CFO",
    company: "Acme Co",
  ...
  {
    testimonial:
      "I've never met a web developer who truly cares about their clients' success like Harry does.",
    name: "Chris Brown",
    designation: "COO",
    company: "DEF Corp",
  ...
  {
    testimonial:
      "After Harry optimized our website, our traffic increased by 50%. We can't thank them enough!",
    name: "Lisa Wang",
    designation: "CTO",
